...
$lang = array(
  ...
  'deleteserverq' => "Êtes-vous sûrs de vouloir supprimer le serveur ?",
  'reinstallquestion' => "Êtes-vous sûrs de vouloir réinstaller ce serveur de jeu ? Cette opération peut durer plusieurs minutes.",
  'backupquestion' => "Êtes-vous sûrs de vouloir faire un backup ? Le serveur sera éteint pendant le backup",
  'suspendquestion' => "Êtes-vous sûrs de vouloir suspendre ce serveur de jeu ?",
  'unsuspendquestion' => "Êtes-vous sûrs que vous voulez réactiver le serveur de jeu? Réactiver le serveur de jeu réactivera également l'utilisateur.",
  'stopquestion' => "Êtes-vous sûrs de vouloir arréter ce serveur ?",
  'startquestion' => "Êtes-vous sûrs de vouloir démarrer ce serveur ?",
  'restartquestion' => "Êtes-vous sûrs de vouloir redémarrer ce serveur ?",
  'addgameserver' => "Ajouter un serveur de jeu",
  'servercontrol' => "Accorder start/stop/restart",
  'deletegamesh' => "Supprimer le jeu",
  ...
  'machinesuccessful' => "Connexion réussite",
  'iphasservices' => "You cannot delete an IP that has servers on it.",
  'ipremoved' => "L'addrese IP à été supprimée.",
  ...
  'norecentevents' => "Pas d'événement récent.",
  ...
  'requestprocessing2' => "Merci de patienter pendant que nous effectuons l'action demandée.",
  'service' => "Service",
  'ipport' => "IP:PORT",
  'installed' => "Installé",
  ...
  'import_file' => "Importer à partir d'un fichier",
  'import_gsp' => "Importer à partir des templates GSP-Panel",
  ...
  'deletebackupquestion' => "Êtes-vous sûrs de vouloir supprimer ce backup?",
  ...
  'consolelogfirstload' => "Cliquer sur l'icone pour refresh",
  'illegalcharsregex' => "Illegal Characters Regex"
);
